 ...
 */
 ...
 /* Modified by Omegatheme for OMG package */
...
abstract class JHtmlBootstrap
{
	...
	public static function carousel($selector = 'carousel', $params = array())
	{
		...
		if (!isset(self::$loaded[__METHOD__][$sig]))
		{
			...
			//add proxy for getJSObject function from Joomla framework 12, if not exists
			if(method_exists ( "JHtml" , "getJSObject" )){
	...
	public static function loadCss($includeMainCss = true, $direction = 'ltr', $attribs = array())
	{
		...
		if ($direction === 'rtl')
		{
			...
			JHtml::_('stylesheet', 'media/jui/css/bootstrap-responsive-rtl.css', $attribs, false);
		}
	}
	
	//add getJSObject function from Joomla framework 12
	/**
