...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemListCategoriesBlock">
		...
		<div class="itemListSubCategories">
			...
			<div class="subCategoryContainer<?php echo $lastContainer; ?> span<?php echo floor (OGRID_SYS / $this->params->get('subCatColumns')); ?>">
			...
			<?php if((($key+1)%($this->params->get('subCatColumns'))==0)||(($key+1)==count($this->subCategories))): ?>
				<div class="clr"></div>
				<?php if(($key+1)==count($this->subCategories)){
					echo '</div>';
				} else {
	...
	<div class="itemList">
		...
		<div id="itemListLeading">
			...
			<div class="itemContainer<?php echo $lastContainer; ?> span<?php echo floor (OGRID_SYS / $this->params->get('num_leading_columns')); ?>">
				<?php
			...
			<?php if((($key+1)%($this->params->get('num_leading_columns'))==0)||(($key+1)==count($this->leading))): ?>
				<div class="clr"></div>
				<?php if(($key+1)==count($this->leading)){
					echo '</div>';
				} else {
					echo '</div><div class="row-fluid">';
				} ?>
		...
		<div id="itemListPrimary">
			...
			<div class="itemContainer<?php echo $lastContainer; ?> span<?php echo floor (OGRID_SYS / $this->params->get('num_primary_columns')); ?>">
				<?php
					// Load category_item.php by default
					$this->item=$item;
					echo $this->loadTemplate('item');
			...
			<?php if((($key+1)%($this->params->get('num_primary_columns'))==0)||(($key+1)==count($this->primary))): ?>
				<div class="clr"></div>
				<?php if(($key+1)==count($this->primary)){
					echo '</div>';
				} else {
					echo '</div><div class="row-fluid">';
				} ?>
		...
		<div id="itemListSecondary">
			...
			<div class="itemContainer<?php echo $lastContainer; ?> span<?php echo floor (OGRID_SYS / $this->params->get('num_secondary_columns')); ?>">
				<?php
					// Load category_item.php by default
					$this->item=$item;
					echo $this->loadTemplate('item');
			...
			<?php if((($key+1)%($this->params->get('num_secondary_columns'))==0)||(($key+1)==count($this->secondary))): ?>
				<div class="clr"></div>
				<?php if(($key+1)==count($this->secondary)){
					echo '</div>';
				} else {
					echo '</div><div class="row-fluid">';
				} ?>
		...
		<div id="itemListLinks">
			...
			<div class="itemContainer<?php echo $lastContainer; ?> span<?php echo floor (OGRID_SYS / $this->params->get('num_links_columns')); ?>">
				<?php
