...
$Browsecellwidth = ' span' . floor (OGRID_SYS / $this->params->get('latestItemsCols'));
?>
...
<div id="k2Container" class="latestView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="latestItemsContainer<?php echo $Browsecellwidth; ?>">
	...
	<?php if(($key+1)%($this->params->get('latestItemsCols'))==0): ?>
		<div class="clr"></div>
		<?php if(($key+1)==count($this->blocks)){
			echo '</div>';
		} else {
