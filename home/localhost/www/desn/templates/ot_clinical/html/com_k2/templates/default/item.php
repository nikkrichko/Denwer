			...
			<div class="itemLinks">
				...
				<?php if($this->item->params->get('itemTags') && count($this->item->tags)): ?>
					...
					<div class="itemTagsBlock">
						...
						<ul class="itemTags">
							<?php foreach ($this->item->tags as $i=>$tag): ?>
								<li><a href="<?php echo $tag->link; ?>"><?php echo $tag->name; ?></a><?php echo $i+1 == count($item->tags) ? '' : ', '; ?></li>
							<?php endforeach; ?>
						</ul>
						<div class="clr"></div>
					</div>
		...
		<?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
			...
			<div class="itemComments">
				...
				<?php if($this->item->numOfComments>0 && $this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2'))): ?>
						...
						<?php foreach ($this->item->comments as $key=>$comment): ?>
							<li class="<?php echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
								...
								<span class="commentDate">
									<?php echo JText::_('TPL_OT_ON'); ?> <?php echo JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT_LC2')); ?>
								</span>
					...
					<div class="itemCommentsPagination pagination pagination-mini">
