...
?>
<div class="dropdown">
<a class="dropdown-toggle text-center" id="dLabel" role="button" data-toggle="dropdown" data-target="#" href="/page.html">
	<span class="icon-chevron-down floatright"></span>
	<?php echo JText::_('TPL_OT_SELECT_LINK'); ?>
	
</a>
<ul class="dropdown-menu weblinks" role="menu" aria-labelledby="dLabel">
