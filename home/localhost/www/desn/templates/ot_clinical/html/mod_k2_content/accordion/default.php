	...
	<?php if(count($items)): ?>
		<div id="accordion<?php echo $module->id; ?>" class="accordion">
			<?php foreach ($items as $key=>$item):	?>
				<div class="accordion-group k2ItemBlock<?php echo $key==0 ? ' active' : ''; ?>">
					<div class="accordion-heading">
						<?php if($params->get('itemTitle')): ?>
							<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion<?php echo $module->id; ?>" href="#collapse<?php echo $module->id; ?>_<?php echo $key; ?>"><span class="icon-plus-minus"></span></a>
							<a class="moduleItemTitle" href="<?php echo $item->link; ?>"><?php echo $item->title; ?></a>
						<?php endif; ?>
						<div class="clr"></div>
					</div>
					
					<div id="collapse<?php echo $module->id . '_' . $key; ?>" class="accordion-body collapse<?php echo $key==0 ? ' in' : ''; ?>">
